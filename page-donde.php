<?php get_header(); ?>
<script src="https://maps.googleapis.com/maps/api/js?v=3.exp&key=AIzaSyDyPlCDBMjiWLUVPKRlwPbgFrszaB_TeBQ"></script>
...
<div id="where" class="section-div">
	<div class="row">
		<div class="large-8 large-centered medium-10 medium-centered small-12 columns">
			<div class="large-4 medium-4 small-12 columns"><a onclick="cambiaSlide(1)" class="rounded-red-btn"><?php echo get_field('title_section_1'); ?></a></div>
			<div class="large-4 medium-4 small-12 columns"><a onclick="cambiaSlide(2)" class="rounded-red-btn"><?php echo get_field('title_section_2'); ?></a></div>
			<div class="large-4 medium-4 small-12 columns"><a onclick="cambiaSlide(3)" class="rounded-red-btn"><?php echo get_field('title_section_3'); ?></a></div>
		</div>
	</div>
  <div class="row expanded large-collapse medium-collapse small-collapse">
    <div id="slide-1" class="slide large-12 medium-12 small-12 columns">
      ...
      <div id="mapa" class="section-div">
        <div id="map"></div>
        <div class="mapaFull">
          <img style="width:100%" src="<?php bloginfo('template_url') ?>/img/mapaegs.png">
        </div>
      </div>
    </div>
    ...
    <div id="slide-3" class="slide large-12 medium-12 small-12 columns display-none">
      ...
      <a href="<?php echo get_field('como_llegar'); ?>" target="blank"><img class="como-llegar" src="<?php echo get_field('como_llegar'); ?>"></a>
    </div>
  </div>
